...
const Card = ({ item }) => {
  ...
  const styles = {
    ...
    card: `h-[250px] w-[190px] rounded-3xl flex cursor-pointer transition-all duration-400 hover:scale-105 hover:shadow-xl overflow-hidden border shadow-xl border-4 border-[#fb9701]`,
